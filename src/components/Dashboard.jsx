          ...
          {lockChat ? (
            ...
            <>
              ...
              <div
                ...
                className="rounded-full absolute cursor-pointer top-[20px] right-[20px] p-[8px] w-fit duration-[0.5s] hover:bg-slate-300">
              ...
              <div className="w-fit mx-auto bg-slate-900 p-[15px] rounded-xl flex gap-[10px]">
                <input
                  type="text"
