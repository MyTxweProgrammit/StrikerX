        ...
        <div className="center py-[30px]">
          <div className="border border-solid border-[#BFBFBF] w-[270px] pt-[20px] rounded-[10px] shadow-xl center">
            <form>
              ...
              <p className="text-black inter-txwe text-[15px] mt-[-5px]">
              ...
              <div className="relative mt-[15px]">
                <section className="w-fit mx-auto z-10 relative bg-white">
                  <p className="text-[#A7A7A7] inter-txwe px-2 text-[12px]">
                    OR
                  </p>
                </section>
              ...
              <div
                ...
                className="cursor-pointer bg-white border border-solid border-[#CDCDCD] inter-txwe text-[13px] text-center py-[8px] rounded-[20px] mt-[10px] hover:bg-[#CDCDCD] duration-[0.5s] active:bg-[#CDCDCD]"
              >
