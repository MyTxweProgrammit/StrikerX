    ...
    return (
        <div className="relative w-screen h-full">
            ...
            <div className="bg-white w-screen bg-white pt-[10%] pb-[25px] max-[450px]:pt-[80px]" id="test">
                <motion.div className="center" initial={{ opacity: 0, translateY: "-15px" }} animate={{ opacity: 1, translateY: "0px", transition: { duration: 1 } }}> {/* Logo */}
                    <img src={CaptureLogo} />
                </motion.div>
                <motion.p className="text-center bg-conic-180 from-indigo-600 via-indigo-50 to-indigo-600 text-transparent bg-clip-text text-[50px] font-medium max-[520px]:text-[35px]"
                    initial={{ opacity: 0, translateY: "-15px" }}
                    animate={{ opacity: 1, translateY: "0px", transition: { duration: 0.7 } }}
                >StrikerX</motion.p>
                <div className="w-fit mx-auto text-black">
                    <motion.p initial={{ opacity: 0, translateY: "-15px" }} animate={{ opacity: 1, translateY: "0px", transition: { duration: 1 } }} className="text-black text-center text-[26px] font-medium max-[520px]:text-[20px]">The area of code learning for DEV!</motion.p>
                </div>
                <motion.div initial={{ opacity: 0, translateY: "-15px" }} animate={{ opacity: 1, translateY: "0px", transition: { duration: 1 } }} className="mx-auto w-fit h-fit mt-[10px] group">
            ...
            <div className="bg-gradient-left w-screen pt-[20px]">
                <motion.p className="font-bold text-[25px] ml-[20px] max-[520px]:text-[20px] text-white" initial={{ opacity: 0, translateY: "-15px" }} animate={{ opacity: 1, translateY: "0px", transition: { duration: 1 } }}>What will you learn?</motion.p>
                <motion.p className="ml-[20px] bg-conic-180 from-indigo-600 via-indigo-50 to-indigo-600 text-transparent bg-clip-text max-[520px]:text-[13px]" initial={{ opacity: 0, translateY: "-15px" }} animate={{ opacity: 1, translateY: "0px", transition: { duration: 1 } }}>Here is you might like.</motion.p>
                <div className="mt-[20px]"> {/* border of card */}
                    <Marquee className="flex h-[200px]">
                        <motion.div initial={{ opacity: 0, translateY: "-15px" }} animate={{ opacity: 1, translateY: "0px", transition: { duration: 1 } }} className="mx-[10px] w-[300px] h-[171px] bg-[#1f2940] border border-solid border-transparent shadow-xl rounded-[10px] duration-[0.5s] hover:translate-x-[-10px] hover:translate-y-[-10px] cursor-pointer active:translate-x-[-10px] active:translate-y-[-10px]">
            ...
            <div className="relative w-full h-[1380px] bg-[#242424]">
                ...
                <Swiper
                    className={device <= 'mobile' ? "w-[300px] h-[300px] absolute right-[-160px] top-[-180px]" : "w-[300px] h-[300px] mt-[170px]"}
                ...
                >
                    <SwiperSlide>
                        <div className="bg-[#4287f5] w-full h-[87%] pt-[30px] px-[30px] cursor-grab">
                            <p className="text-white font-semibold text-[25px] leading-tight">College <br /> Experience</p>
                            <p className="text-white mt-[10px] text-[14px] leading-tight">There have a course that let you learn it. We have an activity online to give a certificate to you for free.</p>
                        </div>
                    </SwiperSlide>
                    <SwiperSlide>
                        <div className="bg-[#cf00c4] w-full h-[87%] pt-[30px] px-[30px] cursor-grab">
                            <p className="text-white font-semibold text-[25px] leading-tight">Feel Good <br /> To Learn</p>
                            <p className="text-white mt-[10px] text-[14px] leading-tight">This website didn't teach you stressfully. We strict and care about people's emotion. So we want you to enjoy with it.</p>
                        </div>
                    </SwiperSlide>
                    <SwiperSlide>
                        <div className="bg-[#34bfbd] w-full h-[87%] pt-[30px] px-[30px] cursor-grab">
                            <p className="text-white font-semibold text-[25px] leading-tight">Be <br /> Yourself</p>
                            <p className="text-white mt-[10px] text-[14px] leading-tight">Try to demonstrate about your mind. What can you think about design or code. Let's try it by your plan</p>
                        </div>
                    </SwiperSlide>
                    <SwiperSlide>
                        <div className="bg-[#f23d9a] w-full h-[87%] pt-[30px] px-[30px] cursor-grab">
                            <p className="text-white font-semibold text-[25px] leading-tight">Challenge <br /> Yourself</p>
                            <p className="text-white mt-[10px] text-[14px] leading-tight">We want you to think and try to fix your failure. Not to challenge with other people. It can help you to get successful on your position career.</p>
                        </div>
                    </SwiperSlide>
                </Swiper>
            </div>
