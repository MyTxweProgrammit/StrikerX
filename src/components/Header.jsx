...
export default function Header({ wants }) {
  ...
  return (
    <motion.div
      ...
      className={`shadow-sm w-screen h-[60px] around sticky top-0 z-10 bg-white`}
    >
      {wants ? (
        <Link to="/">
          <div className="center gap-[7px]">
            ...
            <div className="center">
              <h3 className="text-[#495199] text-lg font-extrabold max-[440px]:hidden">
                Striker
              </h3>
              <h3 className="text-[#495199] text-lg font-medium max-[440px]:hidden">
                X
              </h3>
            </div>
          </div>
      ...
      <div className="center gap-[10px]">
        <Link to="/signin">
          <div className="text-[#495199] font-medium rounded-lg py-[3px] px-[8px] duration-[0.6s] cursor-pointer hover:bg-[#94bdff] hover:text-white active:bg-[#94bdff] active:text-white">
            Login
          </div>
        </Link>
        <Link to="/signup">
          <div className="text-white font-medium rounded-lg py-[3px] px-[8px] duration-[0.5s] cursor-pointer bg-[#003c9c] hover:bg-[#0062ff] active:bg-[#0062ff]">
            Get Started
          </div>
        </Link>
        <div
