...
export default function Header({ wants }) {
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-[60px] z-50 w-screen transition-all duration-500 bg-white overflow-hidden px-[30px] dark:bg-slate-800 ${
          heightNav ? "h-screen" : "h-0"
        }`}
      >
        <Link style={{ display: "inline-flex", marginTop: 30 }} to="*">
          <span className="w-fit rubik-txwe text-black text-[30px] duration-500 active:ml-[20px] hover:ml-[20px] hover:text-slate-500 dark:text-white">
            Business
          </span>
        ...
        <Link style={{ display: "inline-block" }} to="/feature">
          <p className="w-fit rubik-txwe text-black text-[30px] mt-[30px] duration-500 active:ml-[20px] hover:ml-[20px] hover:text-slate-500 dark:text-white">
            Features
          </p>
        </Link>{" "}
        <br />
        ...
        <p className="w-fit rubik-txwe text-black text-[14px] mt-[30px] duration-500 active:ml-[20px] hover:ml-[20px] hover:text-slate-500 dark:text-slate-400">
          V0.1.0 - ALPHA
        </p>
      </div>
    </>
